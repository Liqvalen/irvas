...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
var forms = function forms(state) {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_24__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка...',
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    // function closeModal(closeSelector, windowsSelector, modalSelector) {
    //     closeSelector.addEventListener('click', () => {
    //         windowsSelector.forEach(item => {
    //             item.style.display = 'none'
    //         })
...
function timer(id, deadline) {
  function getTimeRemaining(endtime) {
    ...
    return {
      //возвращение данных в их обличиях(часах, минутах)
      'total': t,
      'days': days,
      'hours': hours,
      'minutes': minutes,
  ...
  function setClock(selector, endtime) {
    //создание переменных содержащих в себе элементы со страницы
    //
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.container1', '2023-04-31');
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  (0,_modules_images__WEBPACK_IMPORTED_MODULE_6__["default"])(console.log(1));
});
})();
